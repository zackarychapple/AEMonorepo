...
define('emberproj/tests/lint/app.lint-test', [], function () {
  'use strict';
...
define('emberproj/tests/lint/templates.template.lint-test', [], function () {
  'use strict';
...
define('emberproj/tests/test-helper', ['emberproj/app', 'emberproj/config/environment', '@ember/test-helpers', 'ember-qunit'], function (_app, _environment, _testHelpers, _emberQunit) {
  'use strict';
...
require('emberproj/tests/test-helper');
